...
export default function HeroSection () {
  ...
  return (
<div id="home" className="bg-gradient-to-r from-blue-100 from-15% via-pink-100 via-55% to-blue-100 to-100% dark:bg-gradient-to-r dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 dark:text-white herosection-desc relative top-10">
    <div className="sm:grid sm:grid-cols-2 flex flex-col-reverse h-full rounded-b-xl py-12 px-10 justify-center items-center space-x-16">
        <motion.div
            ...
            <span className="dark:text-gray-300 text-blue-950  text-xl md:font-semibold">Hello, I&apos;m</span>
            ...
            <p className=" text-blue-950  dark:text-gray-300 text-xl md:font-semibold ">I&apos;m a detail-driven Javascript developer specializing in creating dynamic and responsive web applications</p>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.5 }} // Wait 1.5s after hero animations
                className="flex gap-6 text-blue-950  dark:text-gray-300 pt-3 pb-3 text-2xl"
            >
        ...
        <motion.div 
                ...
                className="relative rounded-2xl w-full mb-5">
            <Image
                src={theme === 'light' ? '/Myimagelight.jpg' : "/Myimagelight.jpg"}
                alt="profile image"
                width={200}
                height={200}
                className="w-[100%] lg:w-[50%] h-[50%] object-cover rounded-xl"
            />
        </motion.div>
    </div>
</div>
